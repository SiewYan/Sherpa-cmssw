...
namespace METOOLS {
  ...
  class FFV4_Calculator: public Lorentz_Calculator {
  public:
    
    FFV4_Calculator(const Vertex_Key &key):
      Lorentz_Calculator(key) {}

    std::string Label() const { return "FFV4"; }
...
(*j0)[0] = 0.0;
(*j0)[1] = 0.0;
(*j0)[2] = (2.0) * ((j1[0]) * (j2[0]) - ((j1[1]) * (j2[ATOOLS::Spinor<SType>::R1()]))) + (complex(-0.0,-2.0)) * ((j1[1]) * (j2[ATOOLS::Spinor<SType>::R2()])) + (-2.0) * ((j1[0]) * (j2[ATOOLS::Spinor<SType>::R3()]));
(*j0)[3] = (2.0) * ((j1[1]) * (j2[0]) - ((j1[0]) * (j2[ATOOLS::Spinor<SType>::R1()]))) + (complex(0.0,2.0)) * ((j1[0]) * (j2[ATOOLS::Spinor<SType>::R2()])) + (2.0) * ((j1[1]) * (j2[ATOOLS::Spinor<SType>::R3()]));
j0->SetS(j1.S()|j2.S());
return j0;
case 8:
...
(*j1)[0] = (2.0) * ((j0[2]) * (j2[0]) - ((j0[3]) * (j2[ATOOLS::Spinor<SType>::R1()]))) + (complex(0.0,2.0)) * ((j0[3]) * (j2[ATOOLS::Spinor<SType>::R2()])) + (-2.0) * ((j0[2]) * (j2[ATOOLS::Spinor<SType>::R3()]));
(*j1)[1] = (2.0) * ((j0[3]) * (j2[0]) - ((j0[2]) * (j2[ATOOLS::Spinor<SType>::R1()]))) + (complex(-0.0,-2.0)) * ((j0[2]) * (j2[ATOOLS::Spinor<SType>::R2()])) + (2.0) * ((j0[3]) * (j2[ATOOLS::Spinor<SType>::R3()]));
(*j1)[2] = 0.0;
(*j1)[3] = 0.0;
j1->SetS(j0.S()|j2.S());
return j1;
...
case 6:
j2 = CVec4<SType>::New();
(*j2)[0] = (2.0) * ((j0[2]) * (j1[0]) + (j0[3]) * (j1[1]));
(*j2)[ATOOLS::Spinor<SType>::R1()] = (2.0) * ((j0[3]) * (j1[0]) + (j0[2]) * (j1[1]));
(*j2)[ATOOLS::Spinor<SType>::R2()] = (complex(0.0,-2.0)) * ((j0[3]) * (j1[0]) - ((j0[2]) * (j1[1])));
(*j2)[ATOOLS::Spinor<SType>::R3()] = (2.0) * ((j0[2]) * (j1[0]) - ((j0[3]) * (j1[1])));
j2->SetS(j0.S()|j1.S());
return j2;
case 7:
j2 = CVec4<SType>::New();
...
case 15:
j2 = CVec4<SType>::New();
(*j2)[0] = (2.0) * ((j0[2]) * (j1[0]) + (j0[3]) * (j1[1])) + (j0[0]) * (j1[2]) + (j0[1]) * (j1[3]);
(*j2)[ATOOLS::Spinor<SType>::R1()] = (2.0) * ((j0[3]) * (j1[0]) + (j0[2]) * (j1[1])) + -((j0[1]) * (j1[2])) - ((j0[0]) * (j1[3]));
(*j2)[ATOOLS::Spinor<SType>::R2()] = (complex(0.0,-2.0)) * ((j0[3]) * (j1[0]) - ((j0[2]) * (j1[1]))) + (complex(0.0,1.0)) * ((j0[1]) * (j1[2])) + (complex(0.0,-1.0)) * ((j0[0]) * (j1[3]));
(*j2)[ATOOLS::Spinor<SType>::R3()] = (2.0) * ((j0[2]) * (j1[0]) - ((j0[3]) * (j1[1]))) + -((j0[0]) * (j1[2])) + (j0[1]) * (j1[3]);
j2->SetS(j0.S()|j1.S());
return j2;
default:
 THROW(fatal_error, "Massless spinor optimization error in Lorentz calculator");
  ...
  };// end of class FFV4_Calculator

  template class FFV4_Calculator<double>;

}// end of namespace METOOLS

using namespace METOOLS;

DECLARE_GETTER(FFV4_Calculator<double>,"DFFV4",
	       Lorentz_Calculator,Vertex_Key);
Lorentz_Calculator *ATOOLS::Getter
<Lorentz_Calculator,Vertex_Key,FFV4_Calculator<double> >::
operator()(const Vertex_Key &key) const
{ return new FFV4_Calculator<double>(key); }

void ATOOLS::Getter<Lorentz_Calculator,Vertex_Key,
		    FFV4_Calculator<double> >::
