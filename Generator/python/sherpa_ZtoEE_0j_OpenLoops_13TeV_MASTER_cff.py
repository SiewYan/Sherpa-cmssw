...
import os
from SherpaGeneration.Generator.ExtendedSherpaWeights_cfi import *
...
generator = cms.EDFilter("SherpaGeneratorFilter",
  ...
  SherpackLocation = cms.string('/afs/cern.ch/work/s/shoh/analysis/SherpaStudies/Test/CMSSW_9_3_1/src/SherpaGeneration/Generator/test/'),
  SherpackChecksum = cms.string('160e99583dd4bfc7d176fcb957db7662'),
